...
const intro = () => (
  <Layout>
    ...
    <br />Se pensi di aver trovato la soluzione, vai su &nbsp;<a ref="https://hns.to/" target="_blank"> https://hns.to/ </a> e digita nella barra in alto la soluzione senza spazi.
    ...
    <br />Apri &nbsp;<Link to="/spiegazione/">qui</Link> se vuoi altre info sul sistema utilizzato, o se volete semplificare la procedura.
    ...
    <br />Non ci sono altre regole, tutto è permesso.
    </p>
    <p>
      Buona fortuna! &nbsp;<Link to="/spiegazione/">Procedi con il tutorial</Link>.
    </p>
